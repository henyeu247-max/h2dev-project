...
└── H2DEV-Project\                 # NÃO
    ...
    │   └── raw-kenh-mau.json      # 153 record canonical (147 kênh unique · 7 bản ghi trùng channel) · OCR 83 · Vision 124/124 · vidIQ verified 83
    │
    ...
    ├── raw-kenh-goc\             # 130 ảnh raw canonical + metadata (153 record: 23 kênh mới chưa có ảnh chụp) · web bị CHẶN (403)
