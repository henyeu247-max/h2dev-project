...
- Raw channel: 95 source snapshot gốc (12 duplicate archived) + các đợt mở rộng (RAW-110→168) → 156 record canonical (149 kênh unique · 7 bản ghi trùng channel); UI dùng `data-tabs/raw-kenh-mau.json` (156 record, cập nhật 16/09/2026).
