...
- 140 learning records (136 video + 4 Zoom) · 153 tài liệu · 165 kênh (152 live · 13 dead) · 34 ngách · 45 kịch bản · 27 nguồn reup.
- Raw channel: 135 ảnh raw canonical trong `raw-kenh-goc/` (= `assets/raw-kenh/` = 135; 23/156 record chưa có ảnh chụp) + các đợt mở rộng (RAW-110→168) → 156 record canonical (149 kênh unique · 7 bản ghi trùng channel); UI dùng `data-tabs/raw-kenh-mau.json` (156 record, cập nhật 16/09/2026).
