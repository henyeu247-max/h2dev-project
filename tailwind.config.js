...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        brand: { 50:'#fef2f2',100:'#fee2e2',200:'#fecaca',400:'#f87171',500:'#ef4444',600:'#dc2626',700:'#b91c1c',800:'#991b1b' },
        ink: { 50:'#f8fafc', 100:'#f1f5f9', 900:'#0a0c10', 800:'#12151c', 700:'#1a1f2b', 600:'#242b3a', 500:'#2f384d', 400:'#3d4a66' },
